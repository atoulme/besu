...
>
{
    ...
    let permitted = await
    proxy.transactionAllowed(address1, address2, value, gasPrice, gasLimit, payload);
...
// await another
await
proxy.addAccount(address2);
permitted = await
proxy.transactionAllowed(address2, address1, value, gasPrice, gasLimit, payload);
